...
### 主题与模式
只写多处材料支持的主题或模式，单次出现不要强行归纳。
### 可复用沉淀
写能沉淀成文档的稳定结论、方法、原则或判断依据。每项要具体说明“是什么/为什么有用/适用边界”中的至少两点。
### 复习要点
写成复习时可直接看的要点，不要写成提问，不要写未来计划。

禁止输出“今后问题”“还没解决的问题”“建议”“下一步计划”、心理推断或鸡汤，除非原文明确把这些内容写成文档材料。
内容不要过短。材料足够时，每个列表尽量输出 4-10 项；材料不足时写“材料不足，暂不沉淀”。
...
### 反复出现的主题
只写跨周或多天反复出现的主题，证据不足就写“材料不足，暂不沉淀”。
### 可复用沉淀
写能沉淀成文档的稳定结论、方法、原则或判断依据。每项要具体说明“是什么/为什么有用/适用边界”中的至少两点。
### 复习要点
写成复习时可直接看的要点，不要写成提问，不要写未来计划。
...
内容不要过短。材料足够时，每个列表尽量输出 5-12 项；材料不足时写“材料不足，暂不沉淀”。
